- **Definição:** É um conjunto de regras que governa a comunicação de dados entre duas ou mais entidades na rede.
    
- **Elementos Essenciais:**
    
    - _Formato:_ Como as mensagens são estruturadas (onde fica o cabeçalho, onde ficam os dados).
        
    - _Ordem:_ A sequência exata em que as mensagens devem ser enviadas e recebidas.
